...
global.Omi.definePage('page-detail', (_temp = _class = function (_WeElement) {
  ...
  function _TaroComponentClass(props) {
    ...
    _this.$usedState = ["film", "showLoading", "options"];
    _this.data = {
      film: {},
      showLoading: true,
      options: null
  ...
  _createClass(_TaroComponentClass, [{
    ...
    value: function install(options) {
      ...
      _mockData2.default.title = options.title;
      this.data.film = _mockData2.default;
...
}(_index3.WeElement), _class.properties = {}, _class.$$events = [], _temp), "pages/detail/index");
